...
const features = [
  ...
  },
  {
    name: "Grader",
    description:
      "The grader shows you a hyper accurate grade breakdown for each class. It shows also shows you a visualization of your grades",
  ...
  },
  {
    name: "Homework Help",
    description:
      "We use an AI Api to come up with useful answers for all questions. It will be able to be used an unlimited amount of times.",
          ...
          <div>
            ...
            <div>
              <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
                Helping{" "}
                <span className="decoration-indigo-600 text-indigo-600 font-black">
                  students
                </span>
                &nbsp;become their best
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
                The team behind Winston is made for students to be affordable
                and functional for the everyday student wanting to advance
                academically.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Trusted by{" "}
              <span className="font-black text-indigo-600">students</span>{" "}
              globally
            </h2>
            ...
            <div className="relative lg:ml-10">
              ...
              <blockquote className="relative">
                <div className="text-2xl font-medium leading-9 text-gray-900">
                  <p>
                    This new service helped me greatly throughout my time at
                    college. I would recommend this to any student who wants to
                    get more organizied and perform better.
                  </p>
                </div>
              ...
              <div className="relative">
                <div className="sm:text-center">
                  ...
                  <p className="mx-auto mt-6 max-w-2xl text-lg text-indigo-200">
                    Heads up for educators and administrators this student suite
                    may evolve into a simplier more powerful learning management
                    system.
                  </p>
                </div>
                <form
          ...
          <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-12 xl:gap-x-16">
            <div className="lg:col-span-1">
              <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                A simple way of working with grades.
              </h2>
            </div>
