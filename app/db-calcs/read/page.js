    ...
    function readClass(){
        ...
        if(q > 0){
            ...
            if (index > -1) {
                ...
                removed["name"].push((record["data"][q-1]["name"].splice(index, 1)).toString())
                removed["givenGrade"].push(parseInt(record["data"][q-1]["givenGrade"].splice(index, 1)))
                removed["maxGrade"].push(parseInt(record["data"][q-1]["maxGrade"].splice(index, 1)))
                removed["weight"].push(parseInt(record["data"][q-1]["weight"].splice(index, 1)))
                removed["class"].push(parseInt(record["data"][q-1]["class"].splice(index, 1)))
            }
